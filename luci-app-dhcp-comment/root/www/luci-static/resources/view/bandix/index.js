...
function renderUsageRanking(data,showAll){var container=document.getElementById('usage-ranking-container');if(!container)return;if(data.length===0){container.innerHTML='<div class="loading-state">'+_('No data')+'</div>';return;}
